              ...
              <div className="bg-white/80 dark:bg-slate-900/80 backdrop-blur-sm border border-slate-200/50 dark:border-slate-800/50 rounded-2xl p-6 shadow-xl">
                  <form className="space-y-6">
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      ...
                      <Input id="firstName" placeholder="Your first name" className="mt-1 rounded-lg" />
                    </div>
                    <div>
                      <Label htmlFor="lastName" className="text-slate-900 dark:text-slate-50">Last Name</Label>
                      <Input id="lastName" placeholder="Your last name" className="mt-1 rounded-lg" />
                    </div>
                  </div>
                  
                  <div>
                    <Label htmlFor="email" className="text-slate-900 dark:text-slate-50">Email</Label>
                    <Input id="email" type="email" placeholder="your.email@example.com" className="mt-1 rounded-lg" />
                    </div>
                    
                    <div>
                    <Label htmlFor="subject" className="text-slate-900 dark:text-slate-50">Subject</Label>
                    <Input id="subject" placeholder="What's this about?" className="mt-1 rounded-lg" />
                    </div>
                  ...
                  <Button type="submit" size="lg" className="w-full bg-gradient-to-r from-teal-600 to-blue-600 hover:from-teal-700 hover:to-blue-700 rounded-lg shadow-lg">
            ...
            <div className="bg-white/80 dark:bg-slate-900/80 backdrop-blur-sm border border-slate-200/50 dark:border-slate-800/50 rounded-2xl p-8 lg:p-12 shadow-xl">
              ...
              <div className="max-w-md mx-auto">
                <div className="flex gap-2">
                  ...
                  />
                  <Button className="bg-gradient-to-r from-teal-600 to-blue-600 hover:from-teal-700 hover:to-blue-700 rounded-lg shadow-lg">
                    Subscribe
                  </Button>
                </div>
